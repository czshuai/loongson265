...
_Z8LD4_BtoHPKhlPDv8_tS2_S2_S2_:
	...
	sd	$17,16($sp)
	sd	$16,8($sp)
	lui	$28,%hi(%neg(%gp_rel(_Z8LD4_BtoHPKhlPDv8_tS2_S2_S2_)))
	daddu	$28,$28,$25
	daddiu	$28,$28,%lo(%neg(%gp_rel(_Z8LD4_BtoHPKhlPDv8_tS2_S2_S2_)))
	move	$18,$4
	move	$17,$5
	move	$19,$8
	ld	$16,%got_disp(_Z8LD2_BtoHPKhlPDv8_tS2_)($28)
	move	$25,$16
	.reloc	1f,R_MIPS_JALR,_Z8LD2_BtoHPKhlPDv8_tS2_
1:	jalr	$25
	move	$20,$9
...
_Z10LD4_H_BtoHPKhPDv8_tS2_S2_S2_:
	...
	sd	$17,8($sp)
	sd	$16,0($sp)
	lui	$28,%hi(%neg(%gp_rel(_Z10LD4_H_BtoHPKhPDv8_tS2_S2_S2_)))
	daddu	$28,$28,$25
	daddiu	$28,$28,%lo(%neg(%gp_rel(_Z10LD4_H_BtoHPKhPDv8_tS2_S2_S2_)))
	move	$17,$4
	move	$18,$7
	ld	$16,%got_disp(_Z10LD2_H_BtoHPKhPDv8_tS2_)($28)
	move	$25,$16
...
_Z5LD_V8PKhlPDv2_xS2_S2_S2_S2_S2_S2_S2_:
	...
	sd	$17,16($sp)
	sd	$16,8($sp)
	lui	$28,%hi(%neg(%gp_rel(_Z5LD_V8PKhlPDv2_xS2_S2_S2_S2_S2_S2_S2_)))
	daddu	$28,$28,$25
	daddiu	$28,$28,%lo(%neg(%gp_rel(_Z5LD_V8PKhlPDv2_xS2_S2_S2_S2_S2_S2_S2_)))
	move	$18,$4
	move	$17,$5
	move	$19,$10
	ld	$16,%got_disp(_Z5LD_V4PKhlPDv2_xS2_S2_S2_)($28)
	move	$25,$16
...
_Z7L_4x4_BPKhl:
	...
	sd	$31,72($sp)
	sd	$28,64($sp)
	lui	$28,%hi(%neg(%gp_rel(_Z7L_4x4_BPKhl)))
	daddu	$28,$28,$25
	daddiu	$28,$28,%lo(%neg(%gp_rel(_Z7L_4x4_BPKhl)))
	daddiu	$9,$sp,48
	daddiu	$8,$sp,32
	daddiu	$7,$sp,16
	ld	$25,%got_disp(_Z3LW4PKhlPDv4_iS2_S2_S2_)($28)
...
_Z7L_8x8_BPKhlPDv2_xS2_S2_S2_:
	...
	sd	$17,80($sp)
	sd	$16,72($sp)
	lui	$28,%hi(%neg(%gp_rel(_Z7L_8x8_BPKhlPDv2_xS2_S2_S2_)))
	daddu	$28,$28,$25
	daddiu	$28,$28,%lo(%neg(%gp_rel(_Z7L_8x8_BPKhlPDv2_xS2_S2_S2_)))
	move	$22,$4
	move	$21,$5
	move	$19,$6
	move	$18,$7
	move	$17,$8
	ld	$20,%got_disp(_Z3LD4PKhlPDv2_xS2_S2_S2_)($28)
	move	$25,$20
...
_Z9L_4x4_B_HPKhlPDv8_tS2_:
	...
	sd	$17,72($sp)
	sd	$16,64($sp)
	lui	$28,%hi(%neg(%gp_rel(_Z9L_4x4_B_HPKhlPDv8_tS2_)))
	daddu	$28,$28,$25
	daddiu	$28,$28,%lo(%neg(%gp_rel(_Z9L_4x4_B_HPKhlPDv8_tS2_)))
	move	$17,$6
	move	$16,$7
	daddiu	$9,$sp,48
	daddiu	$8,$sp,32
