...
_ZN12_GLOBAL__N_116psyCost_pp_16x16EPKhlS1_l:
	.frame	$sp,192,$31		# vars= 48, regs= 10/8, args= 0, gp= 0
	.mask	0x50ff0000,-72
	.fmask	0xff000000,-8
	.set	noreorder
	.set	nomacro
...
.L1798:
	...
	pckev.h	$w25,$w23,$w25
	subv.h	$w30,$w17,$w30
	asub_s.h	$w23,$w26,$w25
	pckod.h	$w17,$w30,$w27
	addv.h	$w25,$w26,$w25
	pckev.h	$w27,$w30,$w27
	vabs.h	$w24,$w25
	pckod.h	$w30,$w29,$w21
	asub_s.h	$w28,$w17,$w27
	pckev.h	$w21,$w29,$w21
	vbld	$w26,0($8)
	pckod.h	$w29,$w0,$w2
	asub_s.h	$w6,$w30,$w21
	...
	hsub_u.h	$w27,$w27,$w27
	hsub_u.h	$w26,$w26,$w26
	hadd_s.w	$w23,$w23,$w23
	move.v	$w22,$w8
	addv.w	$w23,$w23,$w17
	insve.d	$w22[1],$w18[0]
	addv.w	$w17,$w6,$w1
	...
	pckev.h	$w26,$w25,$w26
	pckev.h	$w19,$w19,$w24
	asub_s.h	$w29,$w31,$w21
	asub_s.h	$w25,$w30,$w19
	asub_s.h	$w27,$w20,$w26
	addv.h	$w19,$w30,$w19
	subv.h	$w18,$w18,$w22
	addv.h	$w21,$w31,$w21
	addv.h	$w22,$w18,$w16
	...
	max_s.h	$w19,$w19,$w24
	max_s.h	$w18,$w18,$w22
	hadd_s.w	$w21,$w21,$w21
	hadd_s.w	$w20,$w20,$w20
	hadd_s.w	$w19,$w19,$w19
	hadd_s.w	$w18,$w18,$w18
	addv.w	$w20,$w21,$w20
	addv.w	$w18,$w19,$w18
	addv.w	$w16,$w20,$w18
...
_ZN12_GLOBAL__N_116psyCost_pp_32x32EPKhlS1_l:
	.frame	$sp,144,$31		# vars= 16, regs= 10/6, args= 0, gp= 0
	.mask	0x50ff0000,-56
	.fmask	0x3f000000,-8
	.set	noreorder
	.set	nomacro
