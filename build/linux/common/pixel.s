...
_ZN12_GLOBAL__N_110sa8d_16x16EPKhlS1_l:
	...
	move	$19,$6
	sd	$2,0($sp)
	ld	$2,%got_page(.LC56)($28)
	sd	$18,88($sp)
	move	$18,$4
	sd	$17,80($sp)
	move	$17,$0
	daddiu	$2,$2,%got_ofst(.LC56)
	sd	$31,152($sp)
	sd	$2,24($sp)
	ld	$2,%got_page(.LC55)($28)
	sd	$fp,144($sp)
	sd	$23,128($sp)
	daddiu	$2,$2,%got_ofst(.LC55)
	sd	$22,120($sp)
	sd	$16,72($sp)
	sd	$4,16($sp)
	sd	$6,56($sp)
...
.L2405:
	...
	ld	$17,%got_page(_ZL17partialButterfly8PKsPsii.constprop.0)($28)
	move	$5,$16
	move	$4,$7
	daddiu	$17,$17,%got_ofst(_ZL17partialButterfly8PKsPsii.constprop.0)
	move	$25,$17
...
1:	jalr	$25
	...
	.set	nomips16
	.set	nomicromips
	.ent	_ZL17partialButterfly4PKsPsii.constprop.1
	.type	_ZL17partialButterfly4PKsPsii.constprop.1, @function
_ZL17partialButterfly4PKsPsii.constprop.1:
	.frame	$sp,48,$31		# vars= 0, regs= 5/0, args= 0, gp= 0
	.mask	0x100f0000,-8
	.fmask	0x00000000,0
	.set	noreorder
	...
	addiu	$3,$6,-1
	sd	$28,40($sp)
	lui	$28,%hi(%neg(%gp_rel(_ZL17partialButterfly4PKsPsii.constprop.1)))
	li	$8,1			# 0x1
	daddu	$28,$28,$25
	sll	$8,$8,$3
	sd	$19,32($sp)
	daddiu	$28,$28,%lo(%neg(%gp_rel(_ZL17partialButterfly4PKsPsii.constprop.1)))
	daddiu	$24,$4,32
	sd	$18,24($sp)
...
.L2409:
	...
	.set	macro
	.set	reorder
	.end	_ZL17partialButterfly4PKsPsii.constprop.1
	.size	_ZL17partialButterfly4PKsPsii.constprop.1, .-_ZL17partialButterfly4PKsPsii.constprop.1
	.section	.rodata.str1.8
	.align	3
.LC142:
...
.L2413:
	...
	ld	$20,%got_page(_ZL17partialButterfly4PKsPsii.constprop.1)($28)
	move	$5,$19
	li	$6,1			# 0x1
	daddiu	$20,$20,%got_ofst(_ZL17partialButterfly4PKsPsii.constprop.1)
	move	$25,$20
	.reloc	1f,R_MIPS_JALR,_ZL17partialButterfly4PKsPsii.constprop.1
1:	jalr	$25
	daddiu	$16,$sp,96
...
1:	jalr	$25
	...
	addv.h	$w2,$w2,$w0
	subv.h	$w3,$w3,$w0
	daddiu	$2,$2,%got_ofst(.LC139)
	dotp_s.w	$w1,$w2,$w4
	vsrarin.h	$w1,$w1,1
	ld.h	$w5,0($2)
	ld	$2,%got_page(.LC140)($28)
	dotp_s.w	$w0,$w3,$w5
	vsrarin.h	$w0,$w0,1
	insve.d	$w1[1],$w0[0]
	shf.w	$w1,$w1,0xd8
	daddiu	$2,$2,%got_ofst(.LC140)
	ld.h	$w7,0($2)
	ld	$2,%got_page(.LC141)($28)
	dotp_s.w	$w2,$w2,$w7
	vsrarin.h	$w2,$w2,1
	daddiu	$2,$2,%got_ofst(.LC141)
	ld.h	$w6,0($2)
	dotp_s.w	$w3,$w3,$w6
	vsrarin.h	$w3,$w3,1
	insve.d	$w2[1],$w3[0]
...
_ZN12_GLOBAL__N_15satd8ILi48ELi64EEEiPKhlS2_l:
	...
	dlsa	$2,$7,$7,1
	sd	$2,64($sp)
	ld	$2,%got_page(.LC64)($28)
	sd	$22,184($sp)
	li	$22,65536			# 0x10000
	sd	$fp,208($sp)
	addiu	$22,$22,1
	move	$fp,$5
	daddiu	$2,$2,%got_ofst(.LC64)
	sd	$23,192($sp)
	move	$23,$7
	sd	$2,72($sp)
	ld	$2,%got_page(.LC63)($28)
	sd	$18,152($sp)
	dlsa	$18,$5,$5,1
	sd	$17,144($sp)
	move	$17,$0
	sd	$16,136($sp)
	daddiu	$2,$2,%got_ofst(.LC63)
	daddiu	$16,$4,48
	sd	$31,216($sp)
	sd	$21,176($sp)
	sd	$20,168($sp)
...
_ZN12_GLOBAL__N_110sa8d_64x64EPKhlS1_l:
	...
	li	$2,8			# 0x8
	sd	$2,184($sp)
	ld	$2,%got_page(.LC148)($28)
	sd	$20,264($sp)
	li	$20,65536			# 0x10000
	sd	$22,280($sp)
	addiu	$20,$20,1
	move	$22,$0
	daddiu	$2,$2,%got_ofst(.LC148)
	sd	$17,240($sp)
	move	$17,$7
	sd	$2,152($sp)
	ld	$2,%got_page(.LC147)($28)
	sd	$16,232($sp)
	move	$16,$5
	sd	$31,312($sp)
	daddiu	$2,$2,%got_ofst(.LC147)
	sd	$fp,304($sp)
	sd	$23,288($sp)
	sd	$21,272($sp)
	sd	$19,256($sp)
...
_ZN4x26522setupPixelPrimitives_cERNS_17EncoderPrimitivesE:
	...
	sd	$2,3200($4)
	ld	$2,%got_page(_ZL6dct8_cPKsPsl)($28)
	ld	$28,256($sp)
	daddiu	$sp,$sp,272
